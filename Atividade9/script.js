...
function menor(){
    ...
    if(num1 < num2){
        if(num2 < num3){
            document.getElementById('resposta').innerText = ' O menor número é: ' + num1;
        }
    }else if(num2 < num3){
        document.getElementById('resposta').innerText = ' O menor número é: ' + num2;
    }else{
        document.getElementById('resposta').innerText = ' O menor número é: ' + num3;
    }  
  }
  ...
  function ordemDecrescente(){
    ...
    //Resultado   
    document.getElementById('resposta').innerText = 'Ordem Decrescente: '  + num1 + ', ' + num2 + ', ' + num3 + '.';
